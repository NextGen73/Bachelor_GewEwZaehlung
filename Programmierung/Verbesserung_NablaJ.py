...
if(__name__=='__main__'):
    ...
    print("Die Anzahl an Teilintervallen wird hier nurnoch benötigt, um die gewichtete Eigenwertzählung, welche in jedem Schritt berechnet wird, um sie später auszugeben, zu approximieren.")
    ...
    print("Dieses Verfahren ist in dieser Form zu ungenau, alsdass es die gewichtete Eigenwertzählung bei System 2 sinnvoll minimieren zu können.")
