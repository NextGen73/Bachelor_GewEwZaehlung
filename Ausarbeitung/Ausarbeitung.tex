...
%                         Für ein beliebiges $\widetilde \lambda \in \C$ sei \footnote{falls $\widetilde{\lambda}$ keiner der Eigenwerte ist,
%                         dann gilt offenbar $P_{\widetilde \lambda} = \varnothing$}
...
\label{sec: Programmieren}
      ...
      \section{Implementation}
            ...
            Da die restlichen Dateien aus \cite{github} nur eine Funktion aus \textit{./Funktionen.py} aufrufen, werden kurz die verschiedenen Funktionen aus dieser Datei erklärt.
            ...
            Eine partielle Ableitung besitzt als Array die Form $(n\times n)$. Um alle partiellen Ableitungen zu einem Array zusammenzuführen, werden dieses Arrays auf die $(n\times n\times 1)$ erweitert, um nun alle partiellen Ableitungen in der dritten Ebene zusammenzufügen (vgl. \cite{numpyAppend}).
            Das Ergebnis besitzt daher die Form $(n\times n\times l)$. Die Funktion \textit{schrittGradientenverfahren()} berechnet den Punkt $s_{k+1}$ aus $s_k$,
            ...
            Für die Ausführbarkeit von \textit{nablaJ\_Stern()} wird die Funktion \zitat{numpy.transpose} \cite{numpyTranspose} benötigt, damit die Multiplikation der Matrizen in \ref{eqn: vollständigeAblL} durchgeführt werden kann.
            ...
            In Kapitel \ref{sec: Programmieren} werden ausschließlich die Ergebnisse des Programms \mbox{\cite[\textit{./erste Implementierung.py}]{github}} behandelt.
      ...
      \section{Grafiken und Erklärung}
            ...
            Mit \textit{erster Eigenwert} werde hier immer der größte Eigenwert bezeichnet, den man sehen kann, mit \textit{zweiter} der nächstkleinere.
...
\label{sec: Verbesserungen}
      ...
      \section{dynamische Schrittweite}
            ...
            Somit erreicht hier das Verfahren in einem Schritt, wofür vorher $n$ Schritten benötigt wurden.
