...
\label{sec: Einleitung}
      ...
      Da durch die Maßnahmen auch diese Matrizen verändert werden, besitzen diese Matrizen eine Abhängigkeit von einem Parameter, der hier Design-Parameter (vgl. \cite[S. 2]{hauptteilTkachuk}) genannt werden soll und mit \s bezeichnet wird.
      ...
      In Kapitel \ref{sec: Programmieren} wird die Zählung der Eigenwerte implementiert und ein Minimierungsverfahren angewendet, welches \s so verändern soll, dass alle Eigenwerte außerhalb des vorgegebenen Intervalls liegen.

      Verbesserungen zu der Implementierung folgen in Kapitel \ref{sec: Verbesserungen}.
