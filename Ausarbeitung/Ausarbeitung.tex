...
\opensymdef
      ...
      \newsym[Element des Matrix-Pencils $(A,B)$]{AlamB}{A-\lambda\,B}
      ...
      \newsym[Auslenkung des k-ten Massepunkts aus der Ruhelage]{xk}{x_k}
      ...
      \newsym[Intervall, definiert durch $\lbrack\lambda_a,\lambda_b\rbrack := \lbrack\omega_a^2,\omega_b^2\rbrack$]{lamAlamB}{[\lambda_a,\lambda_b]}
      \newsym[Funktion, die Eigenwerte auf $\lbrack\lambda_a,\lambda_b\rbrack$ gewichtet zählt]{J}{J(s)}
...
\label{sec: Einleitung}
      ...
      Daher ist es von entscheidender Relevanz, durch bestimmte Maßnahmen die Eigenfrequenzen eines mechanischen Systems so weit weg von den Bereichen der möglichen Erregerfrequenzen zu legen, wie möglich (vgl. \cite[S. 520]{maschinendynamikDresig}).
      ...
      Der Design-Parameter soll dabei aus einer Menge $\Omega$ an zulässigen Parametern stammen.
      ...
      In Kapitel \ref{sec: Programmieren} wird die Zählung der Eigenwerte implementiert und ein Minimierungsverfahren angewendet, welches den Parameter \s so verändern soll, dass $\s \in \Omega$ gilt und alle Eigenwerte außerhalb des vorgegebenen Intervalls liegen.
...
\label{sec: EW Problem_Futamura}
      ...
      \section{Der Matrix-Pencil}
            ...
            denn viele Aussagen aus Kapitel \ref{sec: EW Problem_Futamura} beziehen sich auf eine Menge von Matrizen dieser Form.
...
% hier gibt es noch Verbesserungsbedarf
            ...
            \begin{remark}
                  ...
                  Damit ist auch $(A-\lam B)$ regulär.
            \end{remark}
            Beweis:\\
            Offenbar gilt:
...
% zitat?
      ...
      Anhand dieser Gleichung werden die Matrizen bestimmt.
% sehr komisch
...
% Es muss irgendwo eine Quelle geben, die genau das sagt
            ...
            Um die Darstellung der Kräfte klarer zu gestalten, werden die Kraftpfeile immer so gezeichnet, dass ihre Werte nichtnegativ sind.
            Das bedeutet, dass beide Kräfte entgegen der Auslenkung gezeichnet werden, dies kann man auch in Abb. \ref{fig: KräfteAnFeder} erkennen.
...
% vgl. nicht richtig
            ...
            Da in dieser Ausarbeitung nur Feder-Masse-Systeme behandelt werden, kann man $s$ und $a$ auf die Auslenkungen $(\xk(t))_k$ zurückführen:
            Im Allgemeinen wird hier $s$ durch $(x_{k+1}-\xk)$ und $a$, ähnlich zu Abb. \ref{fig: KräfteAnFeder}, durch die zweite Ableitung $\ddot \xk(t)$ beschrieben.
...
% ähnlich zu Quelle
            ...
            \end{equation}
% diese Gleichungen könnte man weglassen
      ...
      \section{Ermittlung der Matrizen der Systeme}
            ...
            Dann kann dieses System in eine Gleichung der Form (\ref{eqn: Dgl freie Schwingungen}) zusammengefasst werden.
            Hierbei gilt
            \begin{align}
            ...
            Dieses System kann man analog zu oben in eine Gleichung der Form (\ref{eqn: Dgl freie Schwingungen}) umformen.
            ...
            Wie man sieht, gibt es noch zwei unbekannte Parameter: $m$\footnote{es gibt hier eine Doppelbelegung von $m$: einerseits ist es ein Parameter der Massenmatrix, andererseits gibt es die Anzahl an Teilintervallen in Kapitel \ref{sec: Programmieren} an} und $c$.
      ...
      \section{Zusammenhang Eigenwert und Eigenkreisfrequenz}
            \label{sec: Formel EW}      
...
% zitat?
            Dieser Ansatz wird in (\ref{eqn: Dgl freie Schwingungen}) eingesetzt und durch Division mit
            ...
            Um die Theorie aus Kapitel \ref{sec: EW Problem_Futamura} anzuwenden, so definiere wie in \cite[S. 2]{hauptteilTkachuk}
...
% vielleicht eher Finden der Zielfunktion nennen
      ...
      Diese gesuchte Funktion soll von dem Design-Parameter $s$ abhängen und wird offenbar minimal,
...
% zitat
      \section{Vorüberlegungen}
            ...
            Das neue Intervall sei definiert als:
            $$\lamAlamB:=\wAwB\,.$$
            ...
            da nach Kapitel \ref{sec: Formel EW} $N=\{1,\dots,n\}$ gilt.\\
...
% zitat
      ...
      \section{Der Residuensatz und dessen Anwendung}
            ...
            \end{theorem}
            Beweis: siehe \cite[S. 142]{complexAnalysis},\qed
...
% aus den Fingern gesaugt
                  ...
                  \item $\mathbf{n(\gamma, a)}$:
                        ...
                        \begin{equation}
                              ...
                              \end{cases}\,.
                        \end{equation}
                        Hierbei benötigt man das $\gamma$ wie in (\ref{hilfe: complexAnalysis_IntegralEinsDurchX}),
...
% aber hier ist nicht wirklich Omega gleich \C, es gibt ja noch die Polstellen
                  ...
                  \item $\mathbf{\Res_af}$:
                        Nach Beispiel 9.3 aus \cite[S. 142]{complexAnalysis} gelte für eine einfache Polstelle\footnote{es gibt hier nur einfache Polstellen, da nach (\ref{eqn: ZielfunktionMitPolstellen}) kein Term der Form $\frac{1}{(z-\nu)^r},\ r>1$ vorkommen kann}:
                        \begin{equation}
            ...
            Da aber $\lam_k\in \R$ für $k=1,\dots,n$, ist diese Gleichung äquivalent zu
            $$n(\gamma, \lam_k) = \begin{cases}
...
% in Quelle wurde t auf ein Intervall beschränkt, A muss Inverse haben und stetig diffb. sein für alle t, das müsste man noch zeigen
            ...
            \begin{equation}
                  ...
                  \frac{\partial L(z,s)}{\partial s} = g(z)\,\left[\tr\klammer{D \ \frac{dM}{ds}} - \tr\klammer{D \klammer{z \frac{dM}{ds}-\frac{dK}{ds}} D}\right]\,.
            \end{equation}
...
\label{sec: Programmieren}
      ...
      Die Parameter $m$ und $c$ werden für die Massen- und Steifigkeitsmatrizen (\ref{def: M1}) - (\ref{def: K2}) verwendet.
      ...
      \section{Theorie}
            ...
            Die Schrittweite $\lambda_*$ sei hier fest und da das Minimum der gewichteten Eigenwertzählung bekannt ist,
            benötigt man nur Information über $J(s)$, um ein Minimum zu erkennen.
            ...
            Durch (\ref{eqn: Ew Pencil gleich Ew Matrix}) können die Eigenwerte des Matrix-Pencils $K-\lambda M$ einfach bestimmt werden, wodurch die Berechnung von \J durch Gleichung (\ref{def: J original}) trivial wird.
            Aber für $\nabla J(s)$ müsste man die Funktion \J aus (\ref{eqn: JGleichIntTr}) ableiten.
            Um dieses Parameterintegral zu umgehen, approximiere $J(s)$ zunächst durch eine Quadraturformel und differenziere dann diese Approximation $J^*(s)$.
            ...
            Ferner wurde in der zweiten Zeile die Trapezregel angewendet, wie sie in \cite[S. 498]{numerikHermann} beschrieben ist.
            
            Es gilt daher
            \begin{align}
                  J(s) =& \frac{1}{2\pi i}\sum_{k=0}^{m-1}\int_{\gamma_k} L(z,s)\ dz\nonumber\\
                  \approx& \frac{1}{2\pi i}\left[\frac{\pi i \Tilde r} m\sum_{k=0}^{m-1}\klammer{L(z_k, s)+
                  L(z_{k+1}, s)\,\exp\klammer{\frac{2\pi i}{m}}}\,\exp\klammer{\frac{2\pi i k}{m}}\right]\label{def: JSternTrapez}\\
                  =&:J_{\text{Tr}}^*(s)\,.\nonumber
            \end{align}

            \JStern steht hierbei für die approximierte gewichtete Eigenwertzählung durch eine nicht näher bestimmte Quadraturformel.
            Der Index \zitat{Tr} steht hier für die verwendete Trapezregel.
            Man kann leicht sehen, dass mit der Summen- und Faktorregel für Ableitungen
            $$\nabla J_{\text{Tr}}^*(s) = \frac{1}{2\pi i}\left[\frac{\pi i \Tilde r} m\sum_{k=0}^{m-1}\klammer{\partial_s L(z_k, s)+\partial_s L(z_{k+1}, s)\,
            \exp\klammer{\frac{2\pi i}{m}}}\,\exp\klammer{\frac{2\pi i k}{m}}\right]$$
            gilt.

            Die Faktoren vor \JStern und $\nabla J^*(s)$ werden nicht zusammengefasst, da die eckige Klammer die Quadraturformel beschreibt, der Faktor
            $\frac 1 {2\pi i}$ gehört aber nicht zur Quadraturformel, sondern ist wegen der Anwendung des Residuensatzes vorhanden.
            ...
            Die Funktion $\partial_s L(z, s)$ wurde schon in Kapitel \ref{sec: EW Zählung} in Gleichung (\ref{eqn: AbleitungZielfunktion}) definiert.
      ...
      \section{Implementation}
            ...
            Da die restlichen Dateien aus \cite{github} nur eine Funktion aus \textit{./Funktionen.py} aufrufen, werden kurz die verschiedenen Funktionen dieser Datei erwähnt.
            
            Durch die Funktion \textit{init()} können verschiedene Parameter definiert werden. Darunter fallen unter anderem die Anzahl an Freiheitsgraden $n$, die Anzahl an Teilintervallen $m$ und der Inflationsparameter $\alpha$.
            
            \textit{systemAuswaehlen()} wird verwendet, um zu entscheiden, ob System 1 aus Abb. \ref{fig: System 1} oder System 2 verwendet wird. Abhängig davon werden gemäß Kapitel \ref{sec: Programmieren} Variablen wie $\lambda_a$, $\lam_b$ und $s_0$ definiert.
            
            Die vier Funktionen, die mit \textit{quadratureContourIntegralCircle} beginnen, sind Quadraturformeln für einen Kurvenintegral.
            
            \textit{ableitungDurchDifferenz()} approximiert die Ableitung einer Funktion \textit{f} an einer Stelle \textit{x} durch ein Differenzenverfahren, wie es in (\ref{def: DiffVerfahren}) definiert ist.
            Für $\frac{dM}{ds}$ benötigt man aber $l$ partielle Ableitungen, weshalb man die $l$ partiellen Ableitungen einzeln berechnet und zu einer Matrix vereint.
            Eine partielle Ableitung besitzt als Array die Form $(n\times n)$. Um alle partiellen Ableitungen zu einem Array zusammenzuführen, werden dieses Arrays auf die Form $(n\times n\times 1)$ erweitert, um nun alle partiellen Ableitungen in der dritten Ebene zusammenzufügen (vgl. \cite{numpyAppend}).
            Das Ergebnis besitzt daher die Form $(n\times n\times l)$.
            
            Die Funktion \textit{schrittGradientenverfahren()} berechnet den Punkt $s_{k+1}$ aus $s_k$,
            wohingegen \textit{bedingungenPruefen()} prüft, ob ein Wert innerhalb der zulässigen Menge $\Omega$ liegt.
            Sollte dies nicht der Fall sein, wird der Design-Parameter mithilfe einer Projektion wie in \cite[S. 314]{optimierungJarreProjektion} wieder auf $\Omega$ abgebildet
            und im nächsten Schritt wird statt dem berechneten Wert die Projektion verwendet.

            Die Funktion \textit{EigenwerteMinimierenAufIntervall()} definiert wichtige Funktionen, wie \textit{J(), J\_Stern() und nablaJ\_Stern()}, um dann wiederholt \textit{schrittGradientenverfahren()} aufzurufen und somit die Eigenwertzählungen zu minimieren.
            Für die Ausführbarkeit von \textit{nablaJ\_Stern()} wird die Funktion \zitat{numpy.transpose} \cite{numpyTranspose} benötigt, damit die Multiplikation der Matrizen wie in \ref{eqn: vollständigeAblL} durchgeführt werden kann.

            Schließlich wird \textit{minimierenPlottenUndEckdatenAnzeigen()} genutzt, um vorherige Funktion aufzurufen, die benötigte Zeit zu stoppen, die Plots anzuzeigen und einige Kennzahlen des Durchlaufs auszugeben.

            In Kapitel \ref{sec: Programmieren} werden ausschließlich die Ergebnisse des Programms\linebreak
            \mbox{\cite[\textit{./erste Implementierung.py}]{github}} behandelt.
            ...
            Diese Begrenzung kann man umgehen, indem man in Zeile 15 in \textit{./erste Implementierung.py} den Wert des Arguments \mbox{\zitat{maxIter}} beliebig verändert.
            ...
            Die Spalte \zitat{Zeit in s} gibt nur an, wie viel Zeit der Aufruf der Funktion \textit{EigenwerteMinimierenAufIntervall()} benötigte.
            Aufarbeitungen, wie das anschließende Berechnen der Eigenwerte, werden dabei nicht gemessen. \\
      ...
      \section{Grafiken und Erklärung}
            ...
            Oft werden nur Ausschnitte gezeigt, um die Eigenwerte innerhalb des Intervalls deutlicher zu erkennen.
            ...
            Die gepunkteten Linien stellen immer die Grenzen des Intervalls \lamAlamB dar.
            ...
            Mit \zitat{erster Eigenwert} werde hier immer der größte Eigenwert bezeichnet, den man sehen kann, mit \zitat{zweiter Eigenwert} der nächstkleinere.
            Man sehe zuerst in Abb. \ref{fig: Plot_1_100_0.05} und \ref{fig: Plot_1_150_0.05}, dass sich der betrachtete Eigenwert dem oberen Rand des Intervalls ($\lam_b$) nähert, aber ihn nicht überschreitet.
            Daran ändert sich auch nach weiteren 9800 Schritten nichts, wie man anhand von Tabelle \ref{tab: Ergebnisse} vermuten kann.
            ...
            In Abb. \ref{fig: Plot_1_100_0.5} und \ref{fig: Plot_1_150_0.5} kann man die Unterschiede zwischen den Genauigkeiten der Quadraturformeln leicht erkennen: während in Abb. \ref{fig: Plot_1_100_0.5}
            ...
            Bei der Approximation $J^*_\text{Tr}(s)$ wird $L(z,s)$ an den Stellen $z=\lambda_a$ und $z=\lambda_b$ ausgewertet.
            Falls aber ein Eigenwert sich nahe des Intervallrands befindet, so befindet sich eine Stützstelle nahe einer Polstelle, siehe Gleichung (\ref{eqn: ZielfunktionMitPolstellen}).
            ...
            damit er das obere Ende des Intervalls überschreitet, sondern der Design-Parameter wird derart verändert, sodass nun sogar der erste Eigenwert im Intervall liegt.
            ...
            die genaue gewichtete Zählung \J verwendet wird, um zu entscheiden, ob ein Minimum erreicht wurde. Wie man sehen kann verschwinden die genauen Eigenwertzählung bei Schritt 15.
            ...
            Wie man leicht in Abb. \ref{fig: Plot_2_100_0.05} sehen kann, war das Erreichen eines Minimums an zwei Stellen keine kontrollierte, kleine Veränderung:
            ...
            Da schon Veränderungen der Quadraturformel ausreichten, um den Verlauf der Eigenwerte komplett zu verändern\footnote{es reicht sogar ein Wechsel des Gerätes, welches das Programm ausführt, um unterschiedliche Ergebnisse hervorzubringen},
            werden auch andere wichtige Faktoren den Algorithmus und somit die Minimalstelle beeinflussen können.

            Laut \cite[S. 7]{hauptteilTkachuk} hänge der Algorithmus besonders von dem Startwert $s_0$ und seinen Parametern, wie $\alpha$, ab.
...
\label{sec: Verbesserungen}
      ...
      da laut \cite[S. 359]{maschinendynamikDresig} einige tatsächlich verwendete Berechnungsmodelle $n>1.000.000$ Freiheitsgrade besitzen.
      ...
      \section{Verbesserte Quadraturformeln}
            ...
            Durch verbesserte Quadraturformeln sollen die Eigenwerte das Intervall geordnet verlassen und nicht während eines großen Schrittes wie in Abb. \ref{fig: Plot_2_100_0.05}.
            ...
            Die Faktoren vor der Summe wurden wieder nicht gekürzt, da der erste Faktor von der Anwendung des Residuensatzes stammt
            und der zweite Faktor ein Teil der Quadraturformel ist\footnote{falls man die Faktoren kürzen würde, erhält man die Stützstellen $z_k$ und Gewichte $\w_k$ aus \cite[S. 128]{grundlageFutamura},
            ...
            Betrachte nun einen Durchlauf zu System 2:
            ...
            Wir werden nun versuchen, die beobachteten Sprünge zu unterbinden. Nutze dazu eine genauere Quadraturformel: die \zitat{Zweipunkt-Formel} \cite[S. 526]{numerikHermann}.
            Analog zu (\ref{def: JSternTrapez}) und (\ref{def: JSternMittel}) folgt:
            \begin{align}
            ...
            Ferner kommt dazu, dass für System 2 nun auch die Wahl von $m$ eine Rolle spielt: In den Tabellen \ref{tab: Ergebnisse_Mittelpunkt} 
            ...
            Die Tatsache, dass diese zwei Quadraturformeln nicht bei $\lam_a$ und $\lam_b$ ausgewertet werden und sie deshalb in Nähe einer Polstelle genauer approximieren,
            ...
            Für eine immer näher an das Kurvenintegral rückende Polstelle wächst die Approximation durch die Trapezregel aus (\ref{def: JSternTrapez}) sehr stark an.
      ...
      \section{dynamische Schrittweite}
            ...
            Somit erreicht hier das Verfahren in einem Schritt, wofür vorher $p$ Schritte benötigt wurden.
            ...
            da jeder Schritt des Gradientenverfahrens hier zusätzlich aus Unterschritten (der Bestimmung der optimalen Schrittweite) besteht.
            ...
            Für die Bestimmung der optimalen Schrittweite werden hier die Schritte in die Richtung $d$ gegangen, aber schon nach dem ersten Schritt ist diese Richtung im Allgemeinen nicht mehr optimal.
            Ein Verfahren ohne dynamsiche Schrittweite würde nun in wieder in die Richtung des steilsten Abstiegs gehen, wohingegen dieses Verfahren solange in Richtung $d$ geht, bis es einen (bezüglich dieser Richtung) optimalen Parameter $s$ erreicht hat.
      ...
      \section{Approximation der Ableitung der gewichteten Eigenwertzählung}
            ...
            Approximiere nun $\nabla J(s)$ durch die Anwendung eines Differenzenverfahrens auf $J(s)$ aus (\ref{def: J original}),
            ...
            Dieser Durchlauf wird nicht immer durchgeführt, da er zu viel Zeit in Anspruch nimmt.
            ...
            indem die Schrittweite $h$ aus (\ref{def: DiffVerfahren}) verringert wird.
...
\label{sec: Auswertung}
      ...
      Durch eine Substitution erhält man in (\ref{eqn: allg EW Problem mit lam}) ein allgemeines Eigenwertproblem des Matrix-Pencils $(K-\lambda M)$.
      Die gesuchten Eigenwerte sind dabei genau die Eigenkreisfrequenzen des Systems.
      ...
      und ist einfach zu berechnen, hängt aber nicht direkt von dem Design-Parameter ab.
      ...
      Durch mangelnde Möglichkeiten, diese Schrittweite effizient zu berechnen, war dieses Verfahren aber nicht so effektiv, wie das in Kapitel \ref{sec: Programmieren} vorgestellte Gradientenverfahren.
      ...
      Zudem könnte man für Systeme mit einer hohen Anzahl an Freiheitsgraden die Spur($\tr$) in (\ref{eqn: vollständigeAblL}) approximieren.
      ...
      Dazu wäre \zitat{Hutchinson's Schätzer} \cite[S. 142]{hutch++Meyer}\footnote{Übersetzung des Autors} oder dessen Erweiterung \zitat{Hutch++} \cite[S. 142]{hutch++Meyer} nützlich.
