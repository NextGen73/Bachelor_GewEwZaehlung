...
\label{sec: Programmieren}
      ...
      \section{Implementation}
            ...
            Diese Begrenzung kann man umgehen, indem man in Zeile 
            ...
            Hierbei wird in den ersten und letzten beiden Durchläufen eine kurze Schrittweite des Gradientenverfahrens gewählt. In diesen Durchläufen gilt
            $$\lambda_* = 0.05$$.
            Die beiden mittleren Durchläufe werden mit einer Schrittweite $\lambda_* = 0.5$ verwendet.

            \begin{tabular}{lllll}
                 System & $m$ & $\lambda_*$ & Iterationen & Zeit\\
                 \hline
                 1 & 100 & 0.05 & - & - \\
                 1 & 150 & 0.05 & - & - \\
                 \hline
