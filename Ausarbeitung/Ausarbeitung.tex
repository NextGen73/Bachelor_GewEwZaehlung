...
\label{sec: Programmieren}
      ...
      \section{Implementation}
            ...
            Man sieht schon hier an den drei zwei Durchläufen, dass Zeiten über 9 Minuten für ein System mit nur 8 Freiheitsgraden und einem skalarem Design-Parameter völlig unzureichend sind.
      ...
      \section{Grafiken und Erklärung}
            ...
            \begin{figure}[ht]
                  \centering
                  \includegraphics[width=0.9\textwidth, keepaspectratio]{./Plot_1_100_0.05.png}
            ...
            \begin{figure}[ht]
                  \centering
                  \includegraphics[width=0.9\textwidth, keepaspectratio]{./Plot_1_150_0.05.png}
            ...
            \begin{figure}[ht]
                  \centering
                  \includegraphics[width=0.9\textwidth, keepaspectratio]{./Plot_1_100_0.5.png}
            ...
            \begin{figure}[ht]
                  \centering
                  \includegraphics[width=0.9\textwidth, keepaspectratio]{./Plot_1_150_0.5.png}
                  \caption{Plots zu System 1, $m=100$, $\lam_*=0.5$}
            ...
            \begin{figure}[ht]
                  \centering
                  \includegraphics[width=0.9\textwidth, keepaspectratio]{./Plot_2_100_0.05.png}
            ...
            \begin{figure}[ht]
                  \centering
                  \includegraphics[width=0.9\textwidth, keepaspectratio]{./Plot_2_150_0.05.png}
...
\label{sec: Verbesserungen}
      ...
      Immer wenn ein Eigenwert in die Nähe der Intervallgrenze und damit der Integrationskurve kam, wurde die gewichtete Eigenwertzählung falsch approximiert, was dazu führte, dass die Systeme in einem Schritt sehr große Sprünge ausführten.
      ...
      \section{Verbesserte Quadraturformeln}
            ...
            Dadurch erhofft man sich, dass es keine großen Sprünge in der Verteilung der Eigenwerte mehr gibt, um zu gewährleisten, dass die Eigenwerte geordnet das Intervall verlassen und nicht per Zufall wie in Abb. \ref{fig: Plot_2_100_0.05}.

            Man nutze daher eine Quadraturformel, welche das Integral zwar approximiert, aber nicht an den Stellen $\lambda_a$ oder $\lam_b$ ausgewertet wird.
            ...
            \begin{align*}
                  ...
                  \approx& L(\Tilde z_0+\Tilde r\exp(\frac{2\pi i}{m}(k+\frac{1}{2})), s)i\Tilde r \exp(\frac{2\pi i}{m}(k+\frac{1}{2})) \frac{2\pi}{m}\\
            ...
            Wobei wieder die Faktoren vor der Summe nicht gekürzt wurden, da der erste Faktor von der Anwendung des Residuensatzes stammt und der zweite Faktor ein Teil der Quadraturformel ist\footnote{falls man die Faktoren kürzt, erhält man die Stützstellen $z_k$ und Gewichte $\w_k$ aus \cite[S. 128]{grundlageFutamura}. Die $\w_k$ werden dort zwar als Gewichte einer Quadraturformel bezeichnet, sie sind aber eher die Gewichte einer Quadraturformel mit dem Faktor $\frac{1}{2\pi i}$ multipliziert.}.
            ...
            Die Ergebnisse können auch in der Datei \textit{./Programmierung/Verbesserung\_Mittelpunkt.py} nachvollzogen werden.

            Wie man sehen kann, erfolgen die Berechnungen der ersten beiden Durchläufe nun viel schneller, da nur 15 Schritte benötigt werden.
            Die Intervallgrenze stellt nun kein Hindernis für den Eigenwert mehr dar.
            Auch alle anderen Durchläufe sind nun zuverlässiger, siehe 3. und 4. welche nun beide in wenigen Schritten ein Ergebnis liefern.
            ...
            Diese Formel erhält man durch Anwenden von \cite[S. 526]{numerikHermann} mit $u= \frac{2\pi}{m}(k+\frac 1 2)$ und $v=\frac \pi m$.

            Es folgen die Ergebnisse des Programms \textit{./Programmierung/Verbesserung\_Gauss2.py}.


            Obwohl diese Quadraturformel eine Gauss-Legendre-Quadratur und somit optimal ist, ergibt sich in der Performance zu der Mittelpunkts-Regel kaum ein Unterschied.
            Man kann sogar so weit gehen und sagen, dass die Mittelpunkts-Regel besser ist, da sie weniger Zeit in Anspruch nimmt.
            ...
            \textit{./Programmierung/Vergleich Quadraturformeln.py} sehen. Dort wurde noch die verschobene Trapezregel angewendet. Diese Trapezregel nutzt nicht mehr die Werte $z_k$ als Stützstellen, sondern die $s_{k+\frac 1 2}$.
            Allein dies macht einen gewaltigen Unterschied:

            Für eine immer näher an $\lambda_b = 1$ rückende Polstelle, wächst die alte Trapezformel sehr stark an. Alle anderen Quadraturformeln gehen stattdessen gegen 0.5.
            Auch hier liegen die Ergebnisse der Mittelpunkts-Regel und der Zweipunkt-Formel sehr dicht beieinander.

            Verwende daher ab nun immer die Mittelpunkts-Regel, um zu einem schnellstmöglichen Ergebnis zu kommen.
