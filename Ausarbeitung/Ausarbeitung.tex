...
% hier gibt es noch Verbesserungsbedarf
            ...
            In Kapitel \ref{sec: EW Zählung} werden daher mithilfe des Residuentheorems die Anzahl der Eigenwerte bestimmt,
            indem man über die Funktion $\tr((zB-A)\inv B)$ integriert.
            Genau dies ist auch der Ansatz in \cite{grundlageFutamura,hauptteilTkachuk}.
